<template>
  <div class="add-restaurant">
    ...
    <el-form ref="restaurant" :model="restaurant" class="addItem">
      ...
      <el-form-item label=" Longitude">
        ...
        <el-button type="warning" class="btn-add" round @click="addItem"
          >Edit</el-button
        >
      </el-form-item>
    </el-form>
...
export default {
  ...
  created() {
    ...
    axios
      .get(
        `https://restaurant-e535d-default-rtdb.firebaseio.com/restaurants/${this.$route.params.id}.json`
      )
      .then((res) => {
